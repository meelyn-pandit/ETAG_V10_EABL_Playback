/*
  ...
  Jan 2021 - Integrating generic DFRobotMini MP3 Player to determine if playback affects RFID read range of antennas
*/
...
void loop() { // Main code is here, it loops forever:
  ...
  String currentTime;   //used for current time in hh:mm:ss format, use this for turning on the speaker
  String currentDateTime;  //conbines other strings

  ///////GPS clock calibration///////////GPS clock calibration/////// turn off gps by entering in 999 in load.txt file on sd card
...
//          MP3off();
          birdFed = 1;                                // set birdFed varible to 1 to indicate that the bird was given food access. Can change 
        }
      }
    }
